# AGENTS.md - smallzh.python 项目指南

## 项目概述

这是一个记录 Python 关键知识的文档项目，使用 MkDocs 构建。项目目标是记录作者对 Python 的理解和学习笔记，涵盖从基础语法到常用库的各个方面。

**注意**: 所有 Python 内容基于 Python 3.13+ 进行说明，项目要求 Python 3.13+ 环境。
...
│   ├── string.md           # 字符串
│   ├── notes.md            # 注释
│   ├── process_control.md  # 流程控制
│   ├── function.md         # 函数
│   ├── inner_function.md   # 内部函数
│   ├── class.md            # 类
│   ├── modules.md          # 模块
│   ├── iterator_generator.md # 迭代器生成器
│   ├── file.md             # 文件
│   ├── command_line.md     # 命令行
│   ├── all_is_object.md    # 一切皆对象
│   ├── run_model.md        # 运行模型
│   ├── uv.md               # uv 包管理器
│   ├── pip.md              # pip
│   ├── setup.md            # setup
│   ├── publish_to_pypi.md  # 发布pip包
│   ├── python_turtle.md    # 海龟绘图
│   ├── flask.md            # Flask 框架
...
1. **Python 版本**: 文档内容基于 Python 3.13+，开发环境需要 3.13+
